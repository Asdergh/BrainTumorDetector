...
class DataHandler():
    ...
    def trashhold_dat(self):
        ...
        for (sample_number, (train_separator_sample,
            ...
            self.train_separator_dataset[sample_number][0] = trashholeded_train_sep
            self.test_separator_dataset[sample_number][0] = trashholeded_test_sep
